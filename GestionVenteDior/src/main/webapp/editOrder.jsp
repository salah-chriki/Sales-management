		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid px-5">
				...
				<div class="row my-3">
					...
					<h3 class="fs-2 mb-3">Edit Order</h3>
					<div class="col">
						<form action="editOrder2">
							...
							<div class="mb-3">
								<label class="form-label required">quantity</label> <input
									type="text" class="form-control" value="${qteCmd }"
									name="qteCmd">
							</div>
							<div class="mb-3">
								<s:select class="form-select form-select-sm"
							...
							<div class="mb-3">
								<label class="form-label required">Date</label> <input
									type="date" class="form-control" value="${dateCmd}"
									name="dateCmd" value="2022-02-22" min="2014-01-01"
									max="2030-12-31">
							</div>
